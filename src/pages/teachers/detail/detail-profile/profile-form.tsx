...
export function ProfileForm({ defaultValues, onSubmit, isPending }: ProfileFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <Button type="submit" size="sm" className="gap-1.5 shrink-0" disabled={isPending}>
        ...
        <Tabs defaultValue="main">
          ...
          <TabsContent value="extra" className="p-4 sm:p-5 mt-0 flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              ...
              <Textarea id="bio" placeholder="Qisqacha biografiya..." className="min-h-[90px] resize-none" {...register("bio")} />
            </div>
            <div className="flex flex-col gap-2">
              <Label htmlFor="additionalInfo">Qo'shimcha ma'lumot</Label>
              <Textarea id="additionalInfo" placeholder="Ilmiy yutuqlar, tajriba..." className="min-h-[70px] resize-none" {...register("additionalInfo")} />
            </div>
            <Separator />
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
